        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../page/aboutPage.php">About Us</a>
                    </li>
                        ...
                        <div class="container">
                            ...
                            <div class="container-img">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <img src="../img/24-h copy.png" alt="workingspace" class="img-fluid">
                                        <br><br>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <img src="../img/box copy.png" alt="workingspace" class="img-fluid">
                                        <br><br>
                                        <h6>Safe to the destination</h6>
                                    </div>
                                    <div class="col">
                                        <img src="../img/truck.png" alt="workingspace" class="img-fluid">
                                        <br><br>
                                        <h6>Fast Delivery</h6>
                                    </div>
                                </div>
