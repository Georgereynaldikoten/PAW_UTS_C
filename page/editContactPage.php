<?php
    ...
    $data2 = mysqli_query($con, "SELECT * FROM contact WHERE id_contact='$id_contact'");
            ...
            <form action="../process/editContactProcess.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="no_telp" name="no_telp" required
                        pattern="[0]{1}[8]{1}[0-9]{8,10}" value="<?php echo $data['no_telp'];?>">
                </div>
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary" name="edit">SAVE DATA</button>
                </div>
            </form>
        </div>
